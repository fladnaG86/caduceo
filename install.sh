...
# Usage: curl -sSL https://your-relay.example.com/download/install.sh | bash -s -- --id pc-ufficio --tags ufficio,windows
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --relay     Relay URL (default: wss://your-relay.example.com)"
